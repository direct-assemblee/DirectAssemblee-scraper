...
const DB_WORK_TYPE_QUESTIONS = 'question';
const DB_WORK_TYPE_REPORTS = 'report';
const DB_WORK_TYPE_PROPOSITIONS = 'law_proposal';
const DB_WORK_TYPE_COSIGNED_PROPOSITIONS = 'cosigned_law_proposal';
const DB_WORK_TYPE_COMMISSIONS = 'commission';
const DB_WORK_TYPE_PUBLIC_SESSIONS = 'public_session';
const DB_WORK_TYPE_VOTE_SOLEMN = 'vote_solemn';
...
module.exports = {
    ...
    DB_WORK_TYPE_QUESTIONS: DB_WORK_TYPE_QUESTIONS,
    DB_WORK_TYPE_REPORTS: DB_WORK_TYPE_REPORTS,
    DB_WORK_TYPE_PROPOSITIONS: DB_WORK_TYPE_PROPOSITIONS,
    DB_WORK_TYPE_COSIGNED_PROPOSITIONS: DB_WORK_TYPE_COSIGNED_PROPOSITIONS,
    DB_WORK_TYPE_COMMISSIONS: DB_WORK_TYPE_COMMISSIONS,
    DB_WORK_TYPE_PUBLIC_SESSIONS: DB_WORK_TYPE_PUBLIC_SESSIONS,
    DB_WORK_TYPE_VOTE_SOLEMN: DB_WORK_TYPE_VOTE_SOLEMN,
